...
function beginCountdown() {
  ...
  let downloadTimer = setInterval(function getTime() {
    ...
    //Here  Ive set the interval to stop once the time remaining reaches 0. the clearInterval method stops the setInterval method we're using. Im also setting the timer to 'green' as the time reaches '0'.
    if (timeRemaining <= 0)
      (timer.style.backgroundColor = "green"), clearInterval(downloadTimer);
  }, 1000);
}